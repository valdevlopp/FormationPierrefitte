...
Autre exercice (= signifie affectation)
Quand on pre-formate notre ligne s'instruction avec "Number", le navigateur comprend que nous voulons "attendons de l'utilisateur" un nombre. 
...
(== est égal en valeur et === est égale en valer et en type)
*/
...
/**
 * Créé une condition que si pseudo équivaut à samba et son mail correspond à samba@mail.fr
